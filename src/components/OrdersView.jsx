...
//   //   // Subscriptions
//   //   const subs = [
//   //     client.models.BusinessData.onCreate({ filter }).subscribe({
//   //       next: (item) => setOrders(prev => [...prev, item]),
//   //       error: console.error
//   //     }),
//   //     client.models.BusinessData.onUpdate({ filter }).subscribe({
//   //       next: (item) => setOrders(prev => prev.map(o =>
//   //         o.sk === item.sk ? item : o
//   //       )),
//   //       error: console.error
//   //     }),
//   //     client.models.BusinessData.onDelete({ filter }).subscribe({
//   //       next: (item) => setOrders(prev => prev.filter(o => o.sk !== item.sk)),
//   //       error: console.error
//   //     })
//   //   ];

//   //   unsubscribes = subs.map(sub => sub.unsubscribe.bind(sub));
...
//       try {
//         // --- STEP 1: The Optimized QUERY (Zero Scan) ---
//         // We use the generated method from your schema update
//         // index('pk').sortKeys(['sk']).name('ByBusiness')
//         const { data } = await client.models.BusinessData.listByBusiness({
//           pk: businessPk,
...
//       // We subscribe to events. Note: We still use 'filter' here, 
//       // but Subscription filters are handled efficiently by AppSync/Lambda, not a Table Scan.
//       const subFilter = { 
//         pk: { eq: businessPk }, 
//         sk: { beginsWith: orderPrefix } 
//       };
...
//         next: (newItem) => setOrders(prev => [...prev, newItem])
//       });
