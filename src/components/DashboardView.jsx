    ...
    useEffect(() => {
        ...
        const fetchAiCache = async () => {
            try {
                ...
                // 1. Fetch the cached list generated by the AI
                ...
                if (cacheData && cacheData.recommendations) {
                    ...
                    // Un-wrap if Nova returned an object instead of an array
                    ...
                    // 🟢 THE FIX: Safely extract the phone from the SK instead of relying on the GraphQL schema
                    ...
                    // 🔍 DEBUGGING: Print the exact math to the browser console
                    console.log("🤖 AI Cache Data:", cachedList);
                    console.log("✅ Eligible Live Phones:", eligiblePhones);
